...
def getObjectDimensiont(model,confidence, pipeline, depth_scale, align):
    ...
    tmeass = 0.25
    tInterval = 1.5                                                       #  maybe reduce it to two'''
    tCompare = time.time()
    ...
    return model.names[nearest_details['class_id']], nearest_details['confidence'],gripCords[1], gripCords[0], elapsedTime,gripDist
